...
export default function ViewBusinessAppointmentsPage() {
    const [businessId, setBusinessId] = useState<string>('');
    const { appointments, loading, error } = useViewBusinessAppointments(businessId);

    // @ts-ignore
    const renderAppointment = ({ item }) => (
        <View style={styles.appointment}>
            <Text>Appointment ID: {item.id}</Text>
